...
HOSTCXXFLAGS = -Ofast
KERNELFLAGS  = -mcpu=cortex-a15 -mtune=cortex-a15 -marm -mfpu=neon-vfpv4 -fgcse-las
...
KBUILD_AFLAGS_MODULE  := -DMODULE $(KERNELFLAGS)
KBUILD_CFLAGS_MODULE  := -DMODULE $(KERNELFLAGS)
