 ...
 * (default: 6ms * (1 + ilog(ncpus)) (600000ULL), units: nanoseconds)
 *
 ...
 * (default: 0.75 msec * (1 + ilog(ncpus)) (750000ULL), units: nanoseconds)
 */
unsigned int sysctl_sched_min_granularity = 150000ULL;
unsigned int normalized_sysctl_sched_min_granularity = 1500000ULL;

/*
 * is kept at sysctl_sched_latency / sysctl_sched_min_granularity(8)
 */
 ...
 * (default: 1 msec * (1 + ilog(ncpus)) (1000000UL), units: nanoseconds)
 *
